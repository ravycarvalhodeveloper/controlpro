...
export default function CardCustomer({customer}: {customer: CustomerProps}) {
    ...
    return (
        <article 
            className="flex flex-col bg-gray-100 border-2 p-2 rounded-lg gap-2 hover:scale-105 duration-300">
            <h2>
            ...
            <button 
                ...
                className="bg-red-500 px-4 rounded text-white mt-2 self-start hover:bg-red-700 duration-300 hover:font-bold"
                >Deletar
            </button>
        </article>
    )
