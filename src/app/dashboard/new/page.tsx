        ...
        <Container>
          <main className="mt-9 mb-2">
            <div className="flex items-center gap-3">
                ...
                {customers.length !== 0 && (
                    <>
                    <label className="mb-1 font-medium text-lg">Selecione o client</label>
                ...
                {customers.length === 0 && (
                    <Link href="/dashboard/customer/new">
                        Você ainda não tem nenhuama cliente, <span className="text-blue-500 font-medium">Cadastrar cliente</span>
                    </Link>
                )}
