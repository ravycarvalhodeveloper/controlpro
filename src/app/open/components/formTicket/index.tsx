...
export default function FormTicket({customer}: FormTicketProps) {
    ...
    return (
        <form className="bg-slate-200 mt-6 px-4 py-6 rounded border-2" onSubmit={handleSubmit(handleRegisterTicket)}>
            ...
            <label className="mb-2 mt-2 font-medium text-lg">Descreva o problema</label>
            <textarea 
                className="w-full border-2 rounded-md h-24 resize-none mb-2 mt-2 px-2"
            ...
            <button
                type="submit"
                className="bg-blue-500 hover:bg-blue-600 duration-200 rounded-md w-full h-11 px-2 text-white font-bold"
            >
                Cadastrar
            </button>
        </form>
