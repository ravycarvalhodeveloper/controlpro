            ...
            <main className="flex flex-col mt-4 mb-2">
                {customer ? (
                    <div className='bg-slate-200 py-6 px-4 rounded border-2 flex items-center justify-between'>
                        ...
                        <button onClick={handleClearCustomer} className=' h-8 px-2 flex items-center justify-center rounded-full'>
                            <FiX size={34} color='red'/>
                        </button>
                    </div>
                ): (
                    <form 
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <button type='submit' className="bg-blue-500 flex flex-row gap-3 px-2 h-11 items-center justify-center font-bold text-white rounded hover:bg-blue-600 duration-200">
                                Procurar cliente 
